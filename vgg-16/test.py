...
def main():
    ...
    model_name = MODEL or ck_args.get("model", "vgg16_bn")
    img_size = IMG_SIZE or int(ck_args.get("img_size", 224))
    ...
    if metrics:
        with open(
            out_path.with_suffix(".model_vgg16bn_metrics.txt"),
            "w",
            encoding="utf-8",
        ) as f:
        ...
        print(
            "Saved metrics to:",
            str(out_path.with_suffix(".model_vgg16bn_metrics.txt")),
        )
