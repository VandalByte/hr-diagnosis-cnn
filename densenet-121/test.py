...
def main():
    ...
    if metrics:
        with open(
            out_path.with_suffix(".model_densenet121_metrics.txt"),
            "w",
            encoding="utf-8",
        ) as f:
        ...
        print(
            "Saved metrics to:",
            str(out_path.with_suffix(".model_densenet121_metrics.txt")),
        )
